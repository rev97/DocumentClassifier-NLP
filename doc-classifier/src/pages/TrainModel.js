...
const TrainModel = ({ setTrainresponse }) => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await fetch('https://nlpbackend-126e7eaede21.herokuapp.com/train-model/', {
                method: 'POST',
                body: formData,
            });
    ...
    return (
        <div className="w-full min-h-screen p-2 bg-gray-800 text-white">
            <div className="flex justify-center text-6xl py-10 font-semibold font-serif">Train custom model</div>
